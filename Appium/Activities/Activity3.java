...
public class Activity3 {
    ...
    public void additionTest() {
        ...
        Assert.assertTrue(result.startsWith("= 14"));
    ...
    public void subtractTest() {
        ...
        String result = driver.findElement(AppiumBy.id("com.miui.calculator:id/result")).getText();
        System.out.println("Actual result: " + result);
        Assert.assertTrue(result.startsWith("= 5"));
    ...
    public void multiplyTest() {
        ...
        String result = driver.findElement(AppiumBy.id("com.miui.calculator:id/result")).getText();
        System.out.println("Actual result: " + result);
        Assert.assertTrue(result.startsWith("= 500"));
    ...
    public void divideTest() {
        ...
        String result = driver.findElement(AppiumBy.id("com.miui.calculator:id/result")).getText();
        System.out.println("Actual result: " + result);
        Assert.assertTrue(result.startsWith("= 25"));
